    ...
    def write(self, cr, uid, ids, vals, context=None):
        if 'uom_po_id' in vals:
            ...
            for product in self.browse(cr, uid, ids, context=context):
                ...
                if (not context or not context.get('uom_category_check_disabled')) and old_uom.category_id.id != new_uom.category_id.id:
...
class product_product(osv.osv):
    ...
    _columns = {
        ...
        'ean13': fields.char('EAN13 Barcode', size=13, help="International Article Number used for product identification.", select=True),
