...
class commission_recalc_wizard(osv.osv_memory):
    ...
    def do_recalc(self, cr, uid, ids, context=None):
        ...
        order_obj._calc_sale_commission(cr, uid, order_ids, context)
        invoice_obj._calc_sale_commission(cr, uid, invoice_ids, context)
        
        return res
    
    _inherit = "at_commission.recalc_wizard"
    
commission_recalc_wizard()