...
class hotel_restaurant_reservation(osv.osv):
    ...
    def create_order(self,cr,uid,ids,context=None):        
        for i in self.browse(cr,uid,ids):
            ...
            self.pool.get('hotel.reservation.order').create(cr,uid,{
...
class hotel_restaurant_kitchen_order_tickets(osv.osv):
    ...
    _columns={
        ...
        'kot_list':fields.one2many('hotel.restaurant.order.list','kot_order_list','Restaurant Order List'),
...
class hotel_restaurant_order(osv.osv):
    ...
    _columns={
        ...
        'amount_subtotal': fields.function(_sub_total, string='Subtotal'),
        'amount_total':fields.function(_total,string='Total'),
...
class hotel_restaurant_order_list(osv.osv):
    ...
    _columns={
        ...
        'kot_order_list':fields.many2one('hotel.restaurant.kitchen.order.tickets',"Order List"),
        ...
        'price_subtotal': fields.function(_sub_total, string='Subtotal'),
         }
