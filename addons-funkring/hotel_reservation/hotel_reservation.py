...
class hotel_reservation(osv.osv):
    ...
    _columns = {
                ...
                'reservation_line':fields.one2many('hotel_reservation.line','line_id',string='Reservation Line'),
...
class hotel_reservation_line(osv.osv):
    ...
    _columns = {                
          'line_id':fields.many2one('hotel.reservation',"Reservation"),
          'reserve':fields.many2many('product.product','hotel_reservation_line_room_rel','room_id','hotel_reservation_line_id', string="Reserve", domain="[('isroom','=',True),('categ_id','=',categ_id)]"),   
