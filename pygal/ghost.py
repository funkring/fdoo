...
class Ghost(object):
    ...
    def render_to_svg(self, filename=None):
        """Render the graph, convert it to svg and write it to filename"""
        import cairosvg
        return cairosvg.svg2svg(
            bytestring=self.render(), write_to=filename)
